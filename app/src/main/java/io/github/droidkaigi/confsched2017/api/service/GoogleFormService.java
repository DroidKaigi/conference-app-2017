...
public interface GoogleFormService {
    ...
    Single<Response<Void>> submitQuestionnaire(
            @Field("entry.45076472") String age,
            @Field("entry.1423428529") String usagePeriod,
            @Field("entry.1748620423") String developmentPeriod,
            ...
            @Field("entry.2100414566.other_option_response") String positionOther,
            @Field("entry.1035760212") String channel,
            @Field("entry.1035760212.other_option_response") String channelOther,
            @Field("entry.676422586") String ticket,
            @Field("entry.676422586.other_option_response") String ticketOther,
            @Field("entry.1832736685") String price,
            @Field("entry.455416737") String afterParty,
            @Field("entry.1089426034") String aboutPrice,
            @Field("entry.1556681290") String timeTable,
            @Field("entry.910403137") String yourPriority,
            @Field("entry.221077566") String aboutChoice,
            ...
            @Field("entry.1947460274") String aboutBooth,
            @Field("entry.1647433992") String drink,
            @Field("entry.1195531622") String goods,
            @Field("entry.1701741632") String aboutGoods,
            @Field("entry.1224977534") String equipment,
            @Field("entry.1429181897") String youtube,
            @Field("entry.1147397694") String wantSpeak,
            @Field("entry.2047139770") String joinNextDroidkaigi);

    @POST("1SNBvJernnyBwglNentXxpdSUkWI9U6umWdDs4Na8OIU/formResponse")
    @FormUrlEncoded
    Single<Response<Void>> submitQuestionnaire(@Body Questionnaire questionnaire);
}
